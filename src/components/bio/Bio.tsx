      ...
      <div className="container">
        <div className="section-title">
          ...
          <p>
            ...
            <br />
            <br />
            I'm a very curious individual with a background encompasses competitive swimming, athletics, sports science, coaching, homebrewing, language instruction... and software development! I'm always looking for opportunities to grow, striving to explore my potential but others as well!
            <br /><br />
